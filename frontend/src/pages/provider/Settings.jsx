              ...
              {activeSection === "personal" && (
                <div>
                  <div style={{ marginBottom:"28px" }}>
                    <h2 style={{ color:"#f1f5f9", fontSize:"20px", fontWeight:"700", margin:"0 0 4px 0" }}>Professional Profile</h2>
                    <p style={{ color:"#475569", fontSize:"14px", margin:0 }}>Update your professional details and credentials.</p>
                  </div>
                  ...
                  <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"20px" }}>
                    ...
                    {/* Specialty */}
                    <div>
                      <label style={{ display:"block", color:"#64748b", fontSize:"12px", fontWeight:"600", marginBottom:"8px", textTransform:"uppercase", letterSpacing:"0.5px" }}>Specialty</label>
                    ...
                    {/* License Number */}
                    <div>
                      <label style={{ display:"block", color:"#64748b", fontSize:"12px", fontWeight:"600", marginBottom:"8px", textTransform:"uppercase", letterSpacing:"0.5px" }}>License Number</label>
